...
post_reviewer = LlmAgent(
    ...
    Pass te post text directly to the tool.

    2. If the lengthc check fails (tool result is "fail"), provide specific feedback on what needs to be fixed.
    Use the tool's message as guideline, but add your own professional critique.
    ...
    4. Includes practial applications 
